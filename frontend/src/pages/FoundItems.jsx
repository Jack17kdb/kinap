            ...
            <div className="mx-auto mt-20 max-w-7xl px-4 pb-10">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-4 mb-6">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        {activeFiltersCount > 0 && (
                            <button onClick={clearFilters} className="text-sm text-red-500 hover:underline cursor-pointer">Clear all</button>
                        )}
                    </div>
                ...
                {isFetchingItems ? (
                    ...
                    <div className="text-center py-16 text-gray-400">
                        ...
                        <p className="font-medium text-gray-600">No found items posted yet</p>
                        <p className="text-sm mt-1">Be the first to post something you found!</p>
                    </div>
                ) : (
                    <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        {items.map((item) => (
                            ...
                            >
                                ...
                                <div className="p-4">
                                    <div className="flex items-center justify-between mb-1">
                                        ...
                                        <span className="rounded-full bg-green-100 text-green-600 px-2 py-0.5 text-xs shrink-0 ml-2">Found</span>
                                    </div>
